          ...
          <table className="ys-title-table" cellSpacing="0" cellPadding="0">
            <tr>
              <td align="center" valign="top">
                ...
                <div className="ys-order-title">印刷订单明细单 YX/D B0401</div>
              </td>
            </tr>
          </table>
        </div>
            ...
            <tr>
              <td>
                <p className="ys-info-line">
                  ...
                  <span className="ys-label">印机型号：</span>
                  <input className="ys-input" type="text" value={o.proudnumber || ''} readOnly />
                  <span className="ys-label">发料日期：</span>
                  <input className="ys-input" type="text" value={o.lldate ? dayjs(o.lldate).format('YYYY-MM-DD') : ''} readOnly />
                </p>
                <p className="ys-info-line">
